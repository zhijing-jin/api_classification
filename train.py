...
cnn.add_argument('--channel_size', type=int, default=256, help='size of channels')
cnn.add_argument('--pool_size', type=int, default=3, help='size of channels')
cnn.add_argument('--fc_size', type=int, default=1024, help='size of channels')
cnn.add_argument('--kernel_sizes', nargs="+", type=int, default=[7, 7, 3, 3, 3, 3],
...
def train(train_loader, dev_loader, model, args):
    ...
    for epoch in range(start_epoch, args.epochs + 1):
        ...
        for i_batch, data in enumerate(train_loader, start=start_iter):
            ...
            if args.checkpoint and i_batch % args.checkpoint_per_batch == 0:
...
def main():
    ...
    n_class = train_dataset.get_num_class()
    ...
    # model
    model = CharCNN(n_class=n_class,
                    n_char=args.num_features, max_seq_len=args.l0,
